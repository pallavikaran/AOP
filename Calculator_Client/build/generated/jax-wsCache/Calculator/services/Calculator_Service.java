 ...
 * 
 */
@WebServiceClient(name = "Calculator", targetNamespace = "http://services/", wsdlLocation = "http://localhost:8080/CalculatorService/Calculator?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATOR_QNAME = new QName("http://services/", "Calculator");
    ...
    public Calculator getCalculatorPort() {
        return super.getPort(new QName("http://services/", "CalculatorPort"), Calculator.class);
    }
    ...
    public Calculator getCalculatorPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://services/", "CalculatorPort"), Calculator.class, features);
    }
