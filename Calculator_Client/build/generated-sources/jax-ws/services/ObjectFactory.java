...
public class ObjectFactory {
    ...
    private final static QName _Mul_QNAME = new QName("http://services/", "mul");
    private final static QName _DivResponse_QNAME = new QName("http://services/", "divResponse");
    private final static QName _Div_QNAME = new QName("http://services/", "div");
    private final static QName _SubResponse_QNAME = new QName("http://services/", "subResponse");
    private final static QName _AddResponse_QNAME = new QName("http://services/", "addResponse");
    private final static QName _MulResponse_QNAME = new QName("http://services/", "mulResponse");
    private final static QName _Sub_QNAME = new QName("http://services/", "sub");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://services/", name = "mul")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://services/", name = "divResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://services/", name = "div")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://services/", name = "subResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://services/", name = "mulResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://services/", name = "sub")
